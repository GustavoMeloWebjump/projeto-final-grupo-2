...
class InstallTranslateColorOptions implements DataPatchInterface
{

    const AttributeCodeColor = 'color';
    ...
    public function apply()
    {
        ...
        foreach ($helper as $productType) {
            ...
            $this->attributeOptionManager->add(Product::ENTITY, self::AttributeCodeColor, $attribute);
        }
