...
class WhatsappBlock implements DataPatchInterface
{
     ...
     */
    const IDENTIFIER = 'botao_whatsapp';

    /**
     * @var string TITLE
     */
    const TITLE = 'botao_whatsapp';
