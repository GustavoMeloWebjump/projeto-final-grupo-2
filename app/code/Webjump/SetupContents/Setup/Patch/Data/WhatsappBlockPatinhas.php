 ...
 */
class WhatsappBlockPatinhas implements DataPatchInterface
{
    /**
     * @var string IDENTIFIER
     */
    const IDENTIFIER = 'botao_patinhas';

    /**
     * @var string TITLE
     */
    const TITLE = 'botao_patinhas';
